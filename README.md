...
- **Sale section** — thumbnail gallery, main image swap, **countdown timer** (end time persisted in `localStorage`), and an **image lightbox** with keyboard support (Escape, arrows).
